...
#define EXPORT __declspec(dllexport)
	...
	*************************************************/
	...
	EXPORT void ZPHOTO_LABRGBInitial();
	/*************************************************
	...
	*************************************************/
	...
	EXPORT void ZPHOTO_LABRGBUnitial();

    EXPORT void ZPHOTO_WaterMark(unsigned char *pSrc, int width, int height, int stride, float ratio=2.0f);
...
extern "C" {
    ...
    void ZPHOTO_WaterMark(unsigned char *pSrc, int width, int height, int stride, float ratio=2.0f);
