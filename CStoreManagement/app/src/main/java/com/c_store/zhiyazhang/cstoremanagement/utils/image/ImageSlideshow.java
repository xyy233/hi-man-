package com.c_store.zhiyazhang.cstoremanagement.utils.image;
...
import com.c_store.zhiyazhang.cstoremanagement.bean.ImageTitleBean;
...
public class ImageSlideshow extends FrameLayout {
    ...
    private class ImageTitlePagerAdapter extends PagerAdapter {
        @Override
        public int getCount() {
