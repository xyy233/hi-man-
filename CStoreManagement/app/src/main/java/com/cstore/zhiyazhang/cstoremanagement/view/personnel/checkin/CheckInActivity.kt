...
class CheckInActivity(override val layoutId: Int=R.layout.activity_check_in) :MyActivity(),GenericView{
    ...
    override fun initView() {
        my_camera_surface.holder.setFixedSize(320,240)
    ...
    private fun initCamera() {
        ...
        mImageReader!!.setOnImageAvailableListener({ reader ->
            ...
            if (bitmap!=null){
                val newBitmap=MyImage.createWatermark(MyImage.reverseBitmap(bitmap,0),"testttttttttt")
                if (newBitmap!=null) my_camera_img.setImageBitmap(newBitmap)
            }else{
